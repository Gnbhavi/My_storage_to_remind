...
for n in range(5, 20):
    ...
    DNA_code.columns = ['Binary_number', 'Kernel_code', 'Concatenated kernel code', 'DNA_codeword']
# print(DNA_code)

    print('Reverse_compliment_value of {} : {}'.format(n, kc.reverse_compliment_error(pob, pob2)))
